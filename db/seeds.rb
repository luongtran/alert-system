...
user1 = User.find_or_create_by_email :first_name => 'Free', :last_name => 'User', :email => 'free@gmail.com', :password => '123123', :password_confirmation => '123123', :status => 'normal', :frequency => 1, :check_date_time => DateTime.now
user1.add_role :free

user2 = User.find_or_create_by_email :first_name => 'Small', :last_name => 'User', :email => 'small@gmail.com', :password => '123123', :password_confirmation => '123123', :status => 'normal', :frequency => 2, :check_date_time => DateTime.now
user2.add_role :small

user3 = User.find_or_create_by_email :first_name => 'Large', :last_name => 'User', :email => 'large@gmail.com', :password => '123123', :password_confirmation => '123123', :status => 'normal', :frequency => 3, :check_date_time => DateTime.now
